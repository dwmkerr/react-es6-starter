...
export default class Home extends React.Component {
  render () {
    return <div>
        ...
        Getting Started with React & ES6</a> article, you can find the code at 
        <a href="https://github.com/dwmkerr/react-es6-starter</a>">github.com/dwmkerr/react-es6-starter</a>.</p>
      </div>;
  }
}
